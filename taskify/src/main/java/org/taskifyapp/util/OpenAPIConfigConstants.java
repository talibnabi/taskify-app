...
public class OpenAPIConfigConstants {
    ...
    public static final String DESCRIPTION = "eTaskify, is a cloud based enterprise task manager platform for organizations where companies\n" +
    ...
    public static final String TITLE = "Taskify Application";
}
